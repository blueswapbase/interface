...
export const colors = {
  ...
  blueswap10: '#344AFB',
  blueVibrant: '#587BFF',
  orangeVibrant: '#Fc894d',
  // TODO: add magenta 50-900
  magenta300: '#FD82FF',
  magentaVibrant: '#A1e44d',
  purple300: '#8440F2',
  purple900: '#1C0337',
...
export const darkTheme = {
  ...
  background: colors.blueswap10,
  backgroundBackdrop: colors.blueswap10,
  backgroundSurface: colors.blueswap10,
  backgroundModule: colors.blueswap10,
  backgroundInteractive: opacify(85, colors.gray950),
  backgroundFloating: opacify(85, colors.gray950),
  backgroundOutline: colors.white,
  ...
  textTertiary: colors.gray100,

  accentAction: colors.greenVibrant,
  accentActive: colors.white,
  accentSuccess: colors.greenVibrant,
  accentWarning: colors.greenVibrant,
  accentFailure: colors.red300,
  accentCritical: colors.red300,

  accentActionSoft: colors.white,
  accentActiveSoft: opacify(85, colors.gray950),
  accentSuccessSoft: colors.greenVibrant,
  accentWarningSoft: opacify(24, colors.greenVibrant),
  ...
  //`0px 40px 120px ${opacify(16, colors.blue400)}`,

  stateOverlayHover: opacify(15, colors.gray300),
  stateOverlayPressed: opacify(8, colors.gray300),
...
export const lightTheme: Theme = {
  ...
  backgroundBackdrop: colors.gray000,
  backgroundSurface: colors.gray000,
  backgroundModule: colors.gray000,
  backgroundInteractive: colors.gray000,
  backgroundFloating: opacify(85, colors.gray950),
  backgroundOutline: colors.blueswap10,
  backgroundScrim: opacify(72, colors.gray900),
  backgroundScrolledSurface: opacify(72, colors.gray900),

  textPrimary: colors.blueswap10,
  textSecondary: colors.blueswap10,
  textTertiary: colors.blueswap10,

  accentAction: colors.orangeVibrant,
  accentActive: colors.blueswap10,
  accentSuccess: colors.greenVibrant,
  accentWarning: colors.orangeVibrant,
  accentFailure: colors.red400,
  accentCritical: colors.red400,

  accentActionSoft: opacify(12, colors.blueswap10),
  accentActiveSoft: '#EEEEEE',
  accentSuccessSoft: opacify(24, colors.greenVibrant),
  accentWarningSoft: opacify(24, colors.orangeVibrant),
  ...
  networkDefaultShadow: '',
  //`0px 40px 120px ${opacify(12, colors.pink400)}`,
