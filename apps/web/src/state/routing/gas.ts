...
<<<<<<< HEAD:src/state/routing/gas.ts
import ERC20_ABI from 'abis/erc20.json'
import { Erc20, Weth } from 'abis/types'
import WETH_ABI from 'abis/weth.json'
import { Currency, SupportedChainsType } from 'blueswap-sdk-core'
import { RPC_PROVIDERS } from 'constants/providers'
=======
import { ChainId, Currency } from '@uniswap/sdk-core'
import { SupportedInterfaceChain } from 'constants/chains'
import { DEPRECATED_RPC_PROVIDERS } from 'constants/providers'
>>>>>>> 18fd136a76bbfa36a06352c87bde60ff3ffe6bce:apps/web/src/state/routing/gas.ts
