...
import { CurrencyAmount, Fraction, Token } from 'blueswap-sdk-core'
...
<<<<<<< HEAD:src/pages/Vote/VotePage.tsx
  background: ${({ theme }) => theme.backgroundSurface};
  border-radius: 5px;
=======
  background: ${({ theme }) => theme.surface1};
  border-radius: 12px;
>>>>>>> 18fd136a76bbfa36a06352c87bde60ff3ffe6bce:apps/web/src/pages/Vote/VotePage.tsx
  padding: 1.5rem;
  position: relative;
  max-width: 640px;
  width: 100%;
