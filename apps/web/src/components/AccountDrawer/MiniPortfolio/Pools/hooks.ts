...
import {
  ...
  MULTICALL_ADDRESSES,
  Token,
<<<<<<< HEAD:src/components/AccountDrawer/MiniPortfolio/Pools/hooks.ts
} from 'blueswap-sdk-core'
import { AddressMap } from 'blueswap-smart-order-router'
=======
...
import MulticallJSON from '@uniswap/v3-periphery/artifacts/contracts/lens/UniswapInterfaceMulticall.sol/UniswapInterfaceMulticall.json'
import { useWeb3React } from '@web3-react/core'
>>>>>>> 18fd136a76bbfa36a06352c87bde60ff3ffe6bce:apps/web/src/components/AccountDrawer/MiniPortfolio/Pools/hooks.ts
