...
<<<<<<< HEAD:src/components/AccountDrawer/MiniPortfolio/ExpandoRow.tsx
  background-color: ${({ theme }) => theme.backgroundInteractive};
  border-radius: 5px;
=======
  background-color: ${({ theme }) => theme.surface3};
  border-radius: 12px;
>>>>>>> 18fd136a76bbfa36a06352c87bde60ff3ffe6bce:apps/web/src/components/AccountDrawer/MiniPortfolio/ExpandoRow.tsx
