...
<<<<<<< HEAD:src/components/TokenSafety/TokenSafetyMessage.tsx
  border-radius: 5px;
  border: 1px solid ${({ theme }) => theme.backgroundOutline};
=======
  border-radius: 16px;
  border: 1px solid ${({ theme }) => theme.surface3};
>>>>>>> 18fd136a76bbfa36a06352c87bde60ff3ffe6bce:apps/web/src/components/TokenSafety/TokenSafetyMessage.tsx
  color: ${({ color }) => color};
`
