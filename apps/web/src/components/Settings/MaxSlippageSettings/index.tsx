...
const Option = styled(Row)<{ isActive: boolean }>`
  ...
  text-align: center;
  gap: 4px;
<<<<<<< HEAD:src/components/Settings/MaxSlippageSettings/index.tsx
  border-radius: 5px;
...
>>>>>>> 18fd136a76bbfa36a06352c87bde60ff3ffe6bce:apps/web/src/components/Settings/MaxSlippageSettings/index.tsx
