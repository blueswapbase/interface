...
<<<<<<< HEAD:src/components/WalletModal/ConnectionErrorView.tsx
      <ButtonPrimary $borderRadius="5px" onClick={retry}>
        <Trans>Try Again</Trans>
=======
      <ButtonPrimary $borderRadius="16px" onClick={retry}>
        <Trans>Try again</Trans>
>>>>>>> 18fd136a76bbfa36a06352c87bde60ff3ffe6bce:apps/web/src/components/WalletModal/ConnectionErrorView.tsx
      </ButtonPrimary>
