...
<<<<<<< HEAD:src/components/RoutingDiagram/RoutingDiagram.tsx
  background-color: ${({ theme }) => theme.backgroundInteractive};
  border-radius: 5px;
=======
  background-color: ${({ theme }) => theme.surface2};
  border-radius: 8px;
>>>>>>> 18fd136a76bbfa36a06352c87bde60ff3ffe6bce:apps/web/src/components/RoutingDiagram/RoutingDiagram.tsx
  display: grid;
  grid-gap: 4px;
