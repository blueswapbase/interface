...
const InputWrapper = styled(Row)<{ isInvalid: boolean }>`
  ...
  position: relative;
  height: 44px;
<<<<<<< HEAD:src/nft/components/profile/list/SetDurationModal.tsx
  border-radius: 5px;
...
>>>>>>> 18fd136a76bbfa36a06352c87bde60ff3ffe6bce:apps/web/src/nft/components/profile/list/SetDurationModal.tsx
  width: 160px;
