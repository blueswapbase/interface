...
const GlobalPriceIcon = styled.div`
  ...
  bottom: 32px;
  right: -10px;
<<<<<<< HEAD:src/nft/components/profile/list/PriceTextInput.tsx
  background-color: ${({ theme }) => theme.backgroundSurface};
  border-radius: 5px;
=======
  background-color: ${({ theme }) => theme.surface1};
  border-radius: 50%;
>>>>>>> 18fd136a76bbfa36a06352c87bde60ff3ffe6bce:apps/web/src/nft/components/profile/list/PriceTextInput.tsx
  height: 28px;
  width: 28px;
  align-items: center;
