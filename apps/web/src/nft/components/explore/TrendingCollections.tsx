...
const Filter = styled.div`
  display: flex;
<<<<<<< HEAD:src/nft/components/explore/TrendingCollections.tsx
  border: 1px solid ${({ theme }) => theme.backgroundOutline};
  border-radius: 5px;
=======
  border: 1px solid ${({ theme }) => theme.surface3};
  border-radius: 16px;
>>>>>>> 18fd136a76bbfa36a06352c87bde60ff3ffe6bce:apps/web/src/nft/components/explore/TrendingCollections.tsx
  padding: 4px;
`
