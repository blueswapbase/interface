...
const BestPriceContainer = styled.div`
  ...
  gap: 8px;
  padding: 12px;
<<<<<<< HEAD:src/nft/components/details/AssetPriceDetails.tsx
...
=======
  ...
  border-radius: 16px;
>>>>>>> 18fd136a76bbfa36a06352c87bde60ff3ffe6bce:apps/web/src/nft/components/details/AssetPriceDetails.tsx
`
